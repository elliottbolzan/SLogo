...
public class Panel extends Group {
	...
	private void setup() {
		...
		Node historyView = addLabelTo(new CommandList(view), "Past Commands");
		Node variableView = addLabelTo(new VariableTable(view), "Variables");
		Node commandView = addLabelTo(new CommandList(view), "User-Defined Commands");
		Button commandReference = makeButton("Command Reference", e -> view.showHelp());
		box.getChildren().addAll(historyView, makeSeparator(), variableView, makeSeparator(), commandView, commandReference);
