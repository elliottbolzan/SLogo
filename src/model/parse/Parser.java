...
////				}
//
//				Token type = Tokenize.determineType(token);
//				if (type == Token.COMMENT) {
//					break;
//				} else if (type == Token.CONSTANT) {
...
//					}
//				}
//				if (tokens.size() == 1 && Tokenize.determineType((tokens.get(0))) == Token.CONSTANT) {
...
//
//		while (index < tokens.size() && !(Tokenize.determineType(tokens.get(index)) == Token.LIST_END)) {
